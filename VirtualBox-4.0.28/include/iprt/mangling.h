...
# define RTErrConvertFromDarwinIO                       RT_MANGLER(RTErrConvertFromDarwinIO)
# define RTErrConvertFromDarwinKern                     RT_MANGLER(RTErrConvertFromDarwinKern)
# define RTR0MachKernelClose                            RT_MANGLER(RTR0MachKernelClose)
# define RTR0MachKernelGetSymbol                        RT_MANGLER(RTR0MachKernelGetSymbol)
# define RTR0MachKernelOpen                             RT_MANGLER(RTR0MachKernelOpen)
